...
<aside id="sidebar"
  ...
  <nav class="flex-1 px-4 py-2 space-y-1 overflow-y-auto min-h-0 overflow-x-hidden">
    ...
    <?php if (isset($_SESSION['rol']) && in_array($_SESSION['rol'], ['Administrador', 'Super'])): ?>
      ...
      <a href="reportes_dinamicos.php"
        class="tooltip-container flex items-center px-4 py-2.5 text-sm font-medium rounded-lg <?php echo ($currentPage == 'reportes_dinamicos.php') ? 'bg-[var(--color-accent)] text-white' : 'hover:bg-[var(--color-bg-primary)]'; ?>">
